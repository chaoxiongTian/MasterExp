...
def return_data(args):
    ...
    if 'MNIST' in name:
        ...
        return loader
    elif 'data_folder' in name:
        train_data = datasets.ImageFolder(root=os.path.join(dset_dir, str(name), 'train'), transform=transform)
        test_data = datasets.ImageFolder(root=os.path.join(dset_dir,str(name), 'test'), transform=transform)
